                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        <form action="{{ route('product-update', $product->id) }}" method="POST" class="p-6 bg-white rounded shadow-md">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="vendor" name="vendor" value="{{ old('vendor', $product->vendor) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
